...
|--------------|----------------|------------------------------------------------------------------------------------------------------|-----------------|
| rego-remover |      1.0.0     | Remove extra files from the build, such as: .bbmodel, .ase and Aseprite Texture Atlas configuration. |        ✔        |
| rego-level    |      1.0.0     | Remove the old world files to new ones on every build. (Need game restart every time)                |        ✖        |
